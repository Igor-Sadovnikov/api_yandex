...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.adressLabel = QtWidgets.QLabel(parent=self.centralwidget)
        self.adressLabel.setText("")
        self.adressLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.adressLabel.setWordWrap(True)
        self.adressLabel.setObjectName("adressLabel")
        self.verticalLayout_2.addWidget(self.adressLabel)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Maps API. Часть №10"))
